...
export default function Home() {
  ...
  return <main>
    <header className="header"><a href="#top" className="brand"><i>F</i>oodieFly</a><nav><a href="#menu">Menu</a><a href="#how">How it works</a><a href="#about">About</a></nav><button className="cartButton" onClick={() => setCartOpen(true)}>Cart <span>{count}</span></button></header>
